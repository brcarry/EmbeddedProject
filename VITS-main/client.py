...
#
#     ret = sk_c.recv(1024)  # 接收消息
#     print(ret.decode('utf-8'))  # 打印接收的消息
#     sk_c.send('windows收到消息!'.encode('utf-8'))  # 向服务器发送消息(bytes)
#     sk_c.close()  # 关闭客户端套接字
#
#
#     filename = './results/paimon_response.mp3'
#     # filename = 'result.mp3'
...
#
#     # conn_pi.send('hello'.encode('utf-8'))  # 向客户端发送信息
#     ret = conn_pi.recv(1024)  # 接收客户端信息(1024字节)
...
server_addr = '172.23.116.224'
# server_addr = '172.23.112.1'
server_port = 8989
# listen_addr = '10.181.243.251'
# listen_addr = '10.192.183.32'
listen_addr = '10.181.250.32'
listen_port = 6666
